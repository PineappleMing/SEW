...
class ESCATissueSuperpixelsDataset(InMemoryDataset):

    def __init__(
            self,
            root,
            raw_root='/mnt/s3/lhm/ESCA_crop/graph_tissue/',
        ...
        super().__init__(os.path.join(root, "ESCA_TISSUE"), transform,
    ...
    def process(self):
        ...
        for g in gs:
            ...
            x, node_y, edge_index, pos, code = graph['x'], graph['nodey'], graph[
