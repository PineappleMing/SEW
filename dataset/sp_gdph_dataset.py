...
class GDPHSuperpixelsDataset(InMemoryDataset):

    def __init__(
            self,
            root,
            raw_root='/mnt/s3/lhm/GDPH/graph_tissue/',
        ...
        super().__init__(os.path.join(root, "TISSUE"), transform,
    ...
    def process(self):
        ...
        for g in gs:
            ...
            x, node_y, edge_index, pos, code = graph['x'], graph['nodey_mapped'], graph[
                'edge'], graph['pos'], graph['code']
