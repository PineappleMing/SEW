...
class HccSuperpixelsDataset(InMemoryDataset):
    def __init__(
            self,
            root,
        ...
        super().__init__(
            os.path.join(root, "HCC"), transform, pre_transform, pre_filter
        )
    ...
    def process(self):
        ...
        for g in gs:
            ...
            x, edge_index, pos, y, code = graph['x'], graph['edge'], graph['pos'], graph['y'], graph['code']
            ...
            data_list.append(Data(x=x, edge_index=edge_index, pos=pos, y=y, code=code))
...
class HccSuperpixelsTestDataset(InMemoryDataset):
    def __init__(
            self,
            root,
            raw_root='/home/lhm/mnt/medical/lhm/liverWSI/gnn_1/',
        ...
        self.raw_root = raw_root
        super().__init__(
            os.path.join(root, "HCC_test"), transform, pre_transform, pre_filter
        )
